...
save(pvalsTRP_anova, pvalsTRP_ats, pvalsTRP_wtps,
     file = "fanova_trp1.RData")
...
save(pvalsCH, pvalsFmaxb, pvalsFP, pvalsGPF, pvalsTRP_anova, pvalsTRP_ats,
     pvalsTRP_wtps,
     file = "fanova.RData")
...
save(pvalsTRP_anova3, pvalsTRP_ats3, pvalsTRP_wtps3,
     pvalsTRP_anova5, pvalsTRP_ats5, pvalsTRP_wtps5,
     file = "fanova_trp2.RData")
